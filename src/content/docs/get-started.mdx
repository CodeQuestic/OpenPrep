...
4. ### Making your Changes
   ...
   <Aside type="caution">
     If there are no activity for 7 days then the issue will be unassigned and
     will be available for others to work on. So, make sure to be active and let
     the maintainers know if you need more time to work on the issue (provide
     the latest updates).
   </Aside>
